...
set(extern_asm "")
set(build_suffix \"\")
set(SLIBSUF \".so\")	# Obviously this can't be hardcoded as Windows uses ".lib" for example
...
/* Here is where ffmpeg's configure script would read options and set the following to '1' or '0' */
/* First set of derived options--tests. We will need to test for these with cmake and assign variables. */
...
/* Second set of derived options--conditionals based on the architecture set in the first set of options. */
...
#define HAVE_WINRT 0
#define HAVE_XLIB 1
/* Third set of derived options--ffmpeg codecs, components, etc. to build. We can probably hardcode these. */
...
/* End of derived options read from configure flags set by either tests or by user arguments */
...
#if(CMAKE_SYSTEM_PROCESSOR MATCHES "aarch64" OR CMAKE_SYSTEM_PROCESSOR MATCHES "ppc" OR CMAKE_SYSTEM_PROCESSOR MATCHES "x86" OR CMAKE_SYSTEM_PROCESSOR MATCHES "amd64" OR CMAKE_SYSTEM_PROCESSOR MATCHES "arm64")
...
# To Do - I've just hardcoded the git info for now; this should be derived programmatically
# In ffmpeg's version.sh script, 'git' is used, but that's an external dependency we don't otherwise need
# we could just output say the first 7 digits of .git/refs/heads/master, but need to account for Windows vs UNIX
